$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            meals.forEach(meal => {
                let mealCard = `
                <div onclick="mealDetail(${meal.idMeal})" id="${meal.idMeal}" class="relative hover:cursor-pointer overflow-hidden w-60 group rounded-xl shadow-md duration-300 text-slate-500 shadow-slate-200">
